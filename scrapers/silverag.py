"""Scraper for SilverAg (silverag.com.sg).

WooCommerce-based with server-rendered prices in SGD.
Categories: /gold/ and /silver/. Products in li.product elements.
"""
...
class SilverAgScraper(BaseScraper):
    dealer_name = "SilverAg"
    base_url = "https://silverag.com.sg"
